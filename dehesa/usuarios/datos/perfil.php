...
/////////////////////////////////////////////////////////////
$ssql_usuarios = "select * from `$tabla11` WHERE Id=$cliente";
...
$mail=$row_usuarios->Email;
$dni=$row_usuarios->Nif;
$telefono1=$row_usuarios->Telefono;
$telefono2=$row_usuarios->Telefono2;
$calle=$row_usuarios->Direccion;
$poblacion=$row_usuarios->Poblacion;
$provincia=$row_usuarios->Provincia;
$fnacimiento=$row_usuarios->FechaNacimiento;
$fecha=explode("-",$fnacimiento);
$fecha_nacimiento=$fecha[2]."-".$fecha[1]."-".$fecha[0]; 
$dia_alta=$row_usuarios->FechaAlta;
...
*/
	...
	echo "<tr>";
		...
		echo "<td><input type='text' readonly name='apellido1' value='".$apellidos."'> </td>";
	echo "</tr>";
	...
	echo "<tr>";
		...
		echo "<td><input type='text' name='calle' value='".$calle."'></td>";
	echo "</tr>";
	echo "<tr>";
		echo "<td id='campo'>Poblaci&oacute;n: </td>";
		echo "<td><input type='text' name='poblacion' value='".$poblacion."'></td>";
	echo "</tr>";
	echo "<tr>";
		echo "<td id='campo'>Provincia: </td>";
		echo "<td><input type='text' name='provincia' value='".$provincia."'></td>";
	echo "</tr>";
...
echo "</table>";
echo "<br><div><div class='nota'>* Por el buen funcionamiento de la web, algunos de los datos no es posible cambiarlos personalmente, para ello, dirijase al gimnasio y el administrador le efectuar&aacute; los cambios.</div><br>";
echo "</div>";
