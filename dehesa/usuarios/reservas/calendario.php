...
if($dia_seleccionado<=$hoy){
	...
	if($mes>$mes_hoy){
	$mes_anterior=$mes-1;
	$dia_mes_anterior=date("d");
	echo "<input type='submit' name='enviar' value='&lt;&lt;'><input type='hidden' name='mes_actual' value='$mes_anterior'><input type='hidden' name='ano_actual' value='$ano'><input type='hidden' name='seleccionado' value='$dia_mes_anterior'></form>";
	}else{
	echo "&nbsp;";
	}
		echo "</td>";
...
$ultimo_dia_enlace=date("d")+$dias_enlace-$ultimo_dia;
	...
	if($mes==$mes_hoy){
		if($ultimo_dia_enlace>=$ultimo_dia){
		$mes_posterior=$mes+1;
		echo "<input type='submit' name='enviar' value='&gt;&gt;'><input type='hidden' name='mes_actual' value='$mes_posterior'><input type='hidden' name='ano_actual' value='$ano'><input type='hidden' name='seleccionado' value='1'></form>";
		}
	}else{
	echo "&nbsp;";
	}
	...
	while ($dia_actual <= $ultimo_dia){
		...
		//si es el uñtimo de la semana, me pongo al principio de la semana y escribo el </tr>
			...
			if (($numero_dia == 5) || ($numero_dia == 6))
			{
				...
				{
					echo "<td class=da>";
					echo "<input type='submit' name='seleccionado' value='$dia_actual' class=da>";
					echo "</td>";
				}
				elseif ($dia_actual == $dia_seleccionado)
				{
				...
				{
					echo "<td class=fs>";
					echo "<input type='submit' name='seleccionado' value='$dia_actual' class=fs>";
					echo "</td>";
				}
					echo "<input type='hidden' name='finde' value='1'>";
			}
			else
			{	
				if ($dia_actual == $dia_seleccionado)
