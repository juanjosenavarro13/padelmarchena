...
$consulta_datos_pista=mysql_query("SELECT * FROM $tabla2 WHERE id_pista=$pista");
$row=mysql_fetch_object($consulta_datos_pista);
...
function generaTipopago($tipo_pago)
{
	include("../../conexion.php"); //Nos conectamos a la base de datos
