...
<?php
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla7` ORDER BY id_solicitud DESC limit $inicio , $TAMANO_PAGINA";
//$ssql = "select * from `$tabla7` ORDER BY 'id_solicitud' DESC limit " . $inicio . "," . $TAMANO_PAGINA;
...
echo "<tr id='cabecera_tabla'> <td> <div id='texto_titulo'> ID </div></td> <td><div id='texto_titulo'> Nombre </div></td> <td><div id='texto_titulo'> Apellidos </div></td>  <td><div id='texto_titulo'> Nick </div></td> <td><div id='texto_titulo'> M&oacute;vil </div></td> <td><div id='texto_titulo'> Acci&oacute;n </div></td> </tr>";
