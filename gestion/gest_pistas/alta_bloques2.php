...
$nhorario= mysqli_query($conexion,$ssql_horario);
	while ($registro_horario=mysqli_fetch_row($nhorario)){
...
$nbloque= mysqli_query($conexion,"SELECT MAX(id_bloque) FROM $tabla4");
	while ($registro=mysqli_fetch_row($nbloque)){
