...
if ($_GET['accion']=="borrar"){
	$id_borrar= $_GET['id'];
	mysql_query("DELETE FROM $tabla8 WHERE id_meapunto='$id_borrar'") or die(mysql_error());
	mysql_close();
	$pagina=$_GET['pagina'];
	header ("Location: $pag");
	exit;
...
echo "<tr id='cabecera_tabla'> <td> <div id='texto_titulo'> ID </div></td> <td><div id='texto_titulo'> Pista </div></td>  <td><div id='texto_titulo'> D&iacute;a </div></td> <td><div id='texto_titulo'> Hora </div></td> <td><div id='texto_titulo'> Usuarios </div></td> <td><div id='texto_titulo'> &nbsp; </div></td> </tr>";
