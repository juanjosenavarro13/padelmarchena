...
if ($_GET['accion']=="borrar"){
	$id_borrar=$_GET['id'];
	mysql_query("DELETE FROM $tabla1 WHERE id_usuario='$id_borrar'") or die(mysql_error());
	mysql_close();
	$pagina=$_GET['pagina'];
	header ("Location: $pag");
	exit;
...
<?php
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla1` ORDER BY apellido1 limit " . $inicio . "," . $TAMANO_PAGINA;
$resultado = mysql_query($ssql);
/////////////////////////////////////////////////////////////

echo "<table border='0' id='tabla_gestion' width='650'>";

echo "<tr id='cabecera_tabla'> <td> <div id='texto_titulo'> ID </div></td> <td><div id='texto_titulo'> Apellidos </div></td> <td><div id='texto_titulo'> Nombre </div></td> <td><div id='texto_titulo'> Nick </div></td> <td><div id='texto_titulo'> M&oacute;vil </div></td> <td><div id='texto_titulo'> Acci&oacute;n </div></td> </tr>";
...
if($i%2==0){
	...
	$estilo="fila_inpar";
		...
		echo "<tr id='".$estilo."'>";
			...
			echo "<td align='left'>".$apellido1." ".$apellido2."</td>";
			echo "<td align='left'>".$nombre."</td>";
//			echo "<td align='left'>".$mail."</td>";
			echo "<td align='left'>".$nick."</td>";
			echo "<td align='left'>".$telefono1."</td>"; 
			echo "<td><a href='?accion=modificar&id=$id_usuario'><img src='../../imagenes/edit.gif' alt='editar' border='0'></a>";
