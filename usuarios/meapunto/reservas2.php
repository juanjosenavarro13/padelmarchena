...
$nreserva= mysqli_query($conexion, "SELECT MAX(id_meapunto) FROM $tabla8");
...
$resultado_nivel = mysqli_query($conexion, $ssql_nivel);
$row_nivel = mysqli_fetch_object($resultado_nivel);
...
//////////////////////////////				GENERA EL ULTIMO ME APUNTO       ///////////////////////////
$napunto= mysqli_query($conexion, "SELECT MAX(id_cliente_meapunto) FROM $tabla9");

	while ($registro=mysqli_fetch_row($napunto)){
	       foreach($registro as $clave){ 
	       //echo $clave;
	 	}
	 }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////	
		...
		$inserta_jugador=mysqli_query($sentencia_jugador,$conexion);
		$inserta=mysqli_query($sentencia,$conexion);
