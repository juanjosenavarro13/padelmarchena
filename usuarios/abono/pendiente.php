...
<div id='boton_nuevo'><a href='abono.php'>VOLVER</a></div>
<br />
 <br />
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla24` WHERE precio1='0' AND debaja=0 AND mes=$mes_actual ORDER BY dia limit " . $inicio . "," . $TAMANO_PAGINA;
...
echo "<a href='pendiente.php?pagina=".$pag_anterior."'>P&aacute;gina anterior</a>";
}
echo "</td>";
...
if ($total_paginas > 1){
    for ($i=1;$i<=$total_paginas;$i++){
       if ($pagina == $i)
          ...
          echo "<a href='pendiente.php?pagina=" . $i . "'class=izquierda>" . $i . "</a> ";
    }
} 
...
if($pagina==$total_paginas){
	...
	echo "<a href='pendiente.php?pagina=".$pag_siguiente."'>P&aacute;gina siguiente</a>";
}
