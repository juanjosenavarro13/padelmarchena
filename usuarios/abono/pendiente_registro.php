...
if ($_GET['accion']=="modificar"){
	...
	header ("Location: modifica_alumnos_registro.php?id=$id_modificar");
	exit;
}
/////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////      PAGINACIÓN     //////////////////////////////////
...
$ssql = "select * from `$tabla25` WHERE debaja=0 AND mes=$mes_consulta AND precio1!=precio1";
...
$tabla12= mysql_query("select precio1, precio2, precio3, precio4 from `$tabla25` WHERE debaja=0");///// CONSULTA DEL TOTAL PRECIO DEL DIA
...
$suma2=0;
$tabla122= mysql_query("select precio1, precio2, precio3, precio4 from `$tabla25` WHERE debaja=0");///// CONSULTA DEL TOTAL PAGADO DEL DIA
...
<div id="cabecera_alumnos">ABONOS PENDIENTES PADEL MARCHENA</div>
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla25` WHERE precio1!=precio1 AND debaja=0 AND mes=$mes_consulta ORDER BY dia limit " . $inicio . "," . $TAMANO_PAGINA;
