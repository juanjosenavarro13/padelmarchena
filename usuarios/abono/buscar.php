...
<div id="cabecera_alumnos"> BUSCADOR ABONOS PADEL MARCHENA</div>
...
<div id='boton_nuevo'><a href='alta_abono.php'>ALTA ABONO</a></div>
<br />
 <br />
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla24` WHERE  dia='$nombre_buscar' AND mes=$mes_actual ORDER BY dia limit " . $inicio . "," . $TAMANO_PAGINA ;
