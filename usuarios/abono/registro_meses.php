...
$ssql2="SELECT COUNT(*) FROM `$tabla25` WHERE precio1=0 AND debaja=0 AND mes=$mes_consulta";  
...
<?php
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla25` WHERE debaja=0 AND mes=$mes_consulta ORDER BY dia limit " . $inicio . "," . $TAMANO_PAGINA ;
...
echo "<a href='registro_meses.php?pagina=".$pag_anterior."'>P&aacute;gina anterior</a>";
}
echo "</td>";
...
if ($total_paginas > 1){
    for ($i=1;$i<=$total_paginas;$i++){
       if ($pagina == $i)
          ...
          echo "<a href='registro_meses.php?pagina=" . $i . "'class=izquierda>" . $i . "</a> ";
    }
} 
...
if($pagina==$total_paginas){
	...
	echo "<a href='registro_meses.php?pagina=".$pag_siguiente."'>P&aacute;gina siguiente</a>";
	echo "<br>";
	echo "<br>";
}
