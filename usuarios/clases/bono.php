...
if ($_GET['id_partido']=="1"){
	$id_usuario=$_GET['id'];
	$b1='1';
	mysql_query("UPDATE `$tabla42` SET b1=$b1 WHERE id_usuario=$id_usuario");
	//mysql_query("UPDATE `$tabla35` SET b1=$b1 WHERE id_usuario=$id_usuario");
	$fecha=date("d-m-Y");
	$datos="b1='$fecha'";
	//mysql_query("UPDATE $base . `$tabla36` SET $datos WHERE id_usuario=$id_usuario");
	mysql_query("UPDATE $base . `$tabla42` SET $datos WHERE id_usuario=$id_usuario") or die(mysql_error());
	mysql_close();
}
if ($_GET['id_partido']=="2"){
	$id_usuario=$_GET['id'];
	$b2='1';
	mysql_query("UPDATE `$tabla42` SET b2=$b2 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="3"){
	$id_usuario=$_GET['id'];
	$b3='1';
	mysql_query("UPDATE `$tabla42` SET b3=$b3 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="4"){
	$id_usuario=$_GET['id'];
	$b4='1';
	mysql_query("UPDATE `$tabla42` SET b4=$b4 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="5"){
	$id_usuario=$_GET['id'];
	$b5='1';
	mysql_query("UPDATE `$tabla42` SET b5=$b5 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="6"){
	$id_usuario=$_GET['id'];
	$b6='1';
	mysql_query("UPDATE `$tabla42` SET b6=$b6 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="7"){
	$id_usuario=$_GET['id'];
	$b7='1';
	mysql_query("UPDATE `$tabla42` SET b7=$b7 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="8"){
	$id_usuario=$_GET['id'];
	$b8='1';
	mysql_query("UPDATE `$tabla42` SET b8=$b8 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="9"){
	$id_usuario=$_GET['id'];
	$b9='1';
	mysql_query("UPDATE `$tabla42` SET b9=$b9 WHERE id_usuario=$id_usuario");
...
if ($_GET['id_partido']=="10"){
	$id_usuario=$_GET['id'];
	$b10='1';
	mysql_query("UPDATE `$tabla42` SET b10=$b10 WHERE id_usuario=$id_usuario");
...
$ssql_usuario = "SELECT nombre, apellido,fecha FROM `$tabla41` WHERE id_usuario=$id_usuario";
$resultado_usuario = mysql_query($ssql_usuario);
$row_usuario = mysql_fetch_object($resultado_usuario);

/*-------------------------------- BUSCAMOS LOS PARTIDOS OCUPADOS ----------------------*/
$ssql_partido = "SELECT * FROM `$tabla42` WHERE id_usuario=$id_usuario";
...
$ssql_fecha = "SELECT * FROM `$tabla42` WHERE id_usuario=$id_usuario";
...
<div id="cabecera_alumnos">CLASES</div>
<br />
