...
$tabla12= mysql_query("select precio from `$tabla14`");///// CONSULTA DEL TOTAL PRECIO DEL DIA
...
$suma2=0;
$tabla122= mysql_query("select pagado from `$tabla14`");///// CONSULTA DEL TOTAL PAGADO DEL DIA
