...
$tabla12= mysql_query("select precio from `$tabla16` WHERE debaja=0 AND mes=$mes_consulta");///// CONSULTA DEL TOTAL PRECIO DEL DIA
...
$suma2=0;
$tabla122= mysql_query("select pagado from `$tabla16` WHERE debaja=0 AND mes=$mes_consulta");///// CONSULTA DEL TOTAL PAGADO DEL DIA
