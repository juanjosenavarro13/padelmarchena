...
<div id='boton_nuevo'><a href='tarifa_plana.php'>VOLVER</a></div>
<br />
 <br />
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla22` WHERE pagado!=precio AND debaja=0 AND mes=$mes_actual ORDER BY apellido limit " . $inicio . "," . $TAMANO_PAGINA;
