...
$ssql2="SELECT COUNT(*) FROM `$tabla23` WHERE pagado=0 AND debaja=0 AND mes=$mes_consulta";  
$consulta2=mysqli_query($conexion, $ssql2); 
...
<?php
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla23` WHERE debaja=0 AND mes=$mes_consulta ORDER BY apellido limit " . $inicio . "," . $TAMANO_PAGINA ;
