...
$tabla12= mysqli_query($conexion, "select precio from `$tabla14`");///// CONSULTA DEL TOTAL PRECIO DEL DIA
...
$suma2=0;
$tabla122= mysqli_query($conexion, "select pagado from `$tabla14`");///// CONSULTA DEL TOTAL PAGADO DEL DIA
...
<div id='boton_nuevo'><a href='lista_alumnos.php'>VOLVER</a></div>
<br />
 <br />
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla14` WHERE n_cuenta4>1 AND debaja=0 ORDER BY apellido limit " . $inicio . "," . $TAMANO_PAGINA;
...
echo "<tr id='cabecera_tabla'> <td> <div id='texto_titulo'> Nombre </div></td>
 <td><div id='texto_titulo'> Apellido </div></td>
   ...
   <td align='center'><div id='texto_titulo'> N cuenta </div></td> 
   <td align='center'><div id='texto_titulo'> N cuenta </div></td> 
   <td align='center'><div id='texto_titulo'> N cuenta </div></td> 
   <td ><div id='texto_titulo'> N cuenta </div></td> 
...
if($i%2==0){
	...
	$estilo="fila_inpar";
		...
		echo "<tr id='".$estilo."'>";
			...
			echo "<td align='center'>".$n_cuenta."</td>";
			echo "<td align='center'>".$n_cuenta2."</td>"; 
			echo "<td align='center'>".$n_cuenta3."</td>"; 
			echo "<td align='center'>".$n_cuenta4."</td>";
