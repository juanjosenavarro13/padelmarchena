...
if ($_GET['accion']=="borrar"){
	$id_borrar=$_GET['id'];
	mysqli_query($conexion, "DELETE FROM $tabla22 WHERE id_alumno='$id_borrar'") or die(mysqli_error());
	mysqli_close();
	//$pagina=$_GET['pagina'];
...
<div id='boton_nuevo'><a href='alta_tarifa_plana.php'>NUEVO ALUMNO</a></div>
<br />
 <br />
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla22` WHERE  nombre='$nombre_buscar' AND mes=$mes_actual ORDER BY apellido limit " . $inicio . "," . $TAMANO_PAGINA ;
