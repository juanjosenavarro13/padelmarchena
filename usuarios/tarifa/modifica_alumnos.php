...
//echo strftime("%d %m %Y");
?>
<div id='boton_nuevo'><a href='tarifa_plana.php'>TARIFA PLANA</a></div>
<br />
<br />
<br />
...
<table border="0" id='tabla_altas'>
	...
	<tr>
		<td>Precio:</td><td><input type='text' name='precio' value='<?php echo $precio; ?>' /> *</td>
	</tr>
	...
	<tr>
		...
		<td><b>Pagado:</b></td><td><input type='text' name='pagado' value='<?php echo $pagado; ?> &euro;' size="10px"> <b>*</b></td>
	</tr>
