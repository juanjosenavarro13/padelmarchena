...
$sql="SELECT COUNT(*) FROM `$tabla37`";  
$consulta=mysql_query($sql); 
$rcount=mysql_result($consulta,0);
/////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////CUENTA NUMERO DE ALUMNOS DE BAJA/////////////////////////////
$ssql="SELECT COUNT(*) FROM `$tabla37`";  
$consulta2=mysql_query($ssql); 
$rcount2=mysql_result($consulta2,0);
/////////////////////////////////////////////////////////////////////////////////////////
$suma=0;

$tabla12= mysql_query("select precio from `$tabla37` ");///// CONSULTA DEL TOTAL PRECIO DEL DIA
...
$suma2=0;
$tabla122= mysql_query("select precio from `$tabla37`");///// CONSULTA DEL TOTAL PAGADO DEL DIA
...
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla37` ORDER BY nombre limit " . $inicio . "," . $TAMANO_PAGINA ;
...
$i++;
	...
	$ssql_partidos = "SELECT SUM(b1+b2+b3+b4+b5+b6+b7+b8+b9+b10) as total FROM `$tabla35` WHERE id_usuario=$id_usuario" ;
...
if($i%2==0){
	...
	$estilo="fila_inpar";
		...
		echo "<tr id='".$estilo."'>";
			...
			echo "<td align='center'>".$partidos."</td>";
	
			echo "<td><a href='padelgym.php?accion=modificar&id=$id_usuario'><img src='../../imagenes/edit.gif' alt='editar' border='0'></a>";
...
echo "<a href='lista_padelgym.php?pagina=".$pag_anterior."'>P&aacute;gina anterior</a>";
}
echo "</td>";
...
if ($total_paginas > 1){
    for ($i=1;$i<=$total_paginas;$i++){
       if ($pagina == $i)
          ...
          echo "<a href='lista_padelgym.php?pagina=" . $i . "'class=izquierda>" . $i . "</a> ";
    }
} 
...
if($pagina==$total_paginas){
	...
	echo "<a href='lista_padelgym.php?pagina=".$pag_siguiente."'>P&aacute;gina siguiente</a>";
	echo "<br>";
	echo "<br>";
}
