...
if ($id_usuario!=""){
$ssql_usuario = "SELECT nombre, apellido, telefono, precio, fecha FROM `$tabla37` WHERE id_usuario=$id_usuario";
$resultado_usuario = mysql_query($ssql_usuario);
$row_usuario = mysql_fetch_object($resultado_usuario);
}
?>

<div id="cabecera_alumnos">ALTA PADELGYM FITNESS CENTER</div>
<br />
<div id="tabla_bono">
