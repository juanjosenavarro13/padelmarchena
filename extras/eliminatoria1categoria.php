...
cuerpo1();
/////////////////////////////////////////////////////////////
$ssql = "select * from `$tabla44` WHERE id=1";
...
/////////////////////////////////////////////////////////////
$ssql_fecha = "select * from `$tabla45` WHERE idfecha=1";
...
/////////////////////////////////////////////////////////////
$ssql_fecha2 = "select * from `$tabla45` WHERE idfecha=2";
...
/////////////////////////////////////////////////////////////
$ssql_fecha3 = "select * from `$tabla45` WHERE idfecha=3";
...
/////////////////////////////////////////////////////////////
$ssql_fecha4 = "select * from `$tabla45` WHERE idfecha=4";
...
/////////////////////////////////////////////////////////////
$ssql_fecha5 = "select * from `$tabla45` WHERE idfecha=5";
...
/////////////////////////////////////////////////////////////
$ssql_fecha6 = "select * from `$tabla45` WHERE idfecha=6";
...
/////////////////////////////////////////////////////////////
$ssql_fecha7 = "select * from `$tabla45` WHERE idfecha=7";
...
<table border='1' id='texto_nocturno'>
	<tr>
        ...
        Eliminatorias 1&deg; Categor&iacute;a<br><br>
   	  </td>
	</tr>

</table>
<div align="center"><a href="clasificacion.php"><b>Volver</b></a></div>    
<form action="eliminatoria1categoriaSQL.php" method="post">
...
<table width="auto" border="0">
  <tr>
    <td>
      <form action="eliminatoria1fecha.php" method="post">
        <table width="auto" border="0">
          <tr>
