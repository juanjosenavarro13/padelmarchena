...
$texto_administrador="
<b>Inscripci&oacute;n para el torneo de 2&ordf; Categor&iacute;a.</b><br><br>
JUGADOR 1<hr>
$nombre1<br>
$apellidos1<br>
$telefono1<br>
...
$asunto="Inscripcion para el torneo de 2&ord; Categor&iacute;a";

if(mail($destino, $asunto, $texto_administrador, 'Content-type: text/html')){
echo "<div id='texto'>Gracias, se han inscrito correctamente al torneo de 2&ord; Categor&iacute;a</div>";
}
