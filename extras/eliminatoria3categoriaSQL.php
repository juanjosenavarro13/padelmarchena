...
session_start();
/////////////////////////////////////////////////////////////
$ssql_consu = "select * from `$tabla48` WHERE id=1";
...
$sentencia2="UPDATE $base . `$tabla48` SET $datos2 WHERE id=1"; //guarda donde id sea igual a 1
...
$modifica2=mysql_query($sentencia2,$conexion);
		...
		$sentencia="INSERT INTO $tabla48 ($campos) VALUES ($datos)  ";
