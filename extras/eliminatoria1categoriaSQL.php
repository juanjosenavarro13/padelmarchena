...
$alumnos='eliminatoria1categoria.php';
session_start();
/////////////////////////////////////////////////////////////
$ssql_consu = "select * from `$tabla44` WHERE id=1";
...
$sentencia2="UPDATE $base . `$tabla44` SET $datos2 WHERE id=1"; //guarda donde id sea igual a 1
...
$modifica2=mysql_query($sentencia2,$conexion);
		...
		$sentencia="INSERT INTO $tabla44 ($campos) VALUES ($datos)  ";
